...
void Back_Stage1_DrawBG(StageBack *back)
{
	Back_Stage1 *this = (Back_Stage1*)back;
...
void Back_Stage1_Free(StageBack *back)
{
	Back_Stage1 *this = (Back_Stage1*)back;
...
StageBack *Back_Stage1_New(void)
{
	//Allocate background structure
	Back_Stage1 *this = (Back_Stage1*)Mem_Alloc(sizeof(Back_Stage1));
	if (this == NULL)
		return NULL;
	...
	this->back.draw_bg = Back_Stage1_DrawBG;
	this->back.free = Back_Stage1_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\STAGES\\STAGE1.ARC;1");
